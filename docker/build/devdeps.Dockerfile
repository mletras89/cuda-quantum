...
ADD https://github.com/mletras89/cuda-quantum/blob/main/scripts/build_llvm.sh /scripts/build_llvm.sh  
...
RUN LLVM_SOURCE=/llvm-project \
    sh /scripts/install_toolchain.sh -e /opt/llvm/bootstrap -t ${toolchain} \
